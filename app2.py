...
intrusion = pickle.load(open('/Users/jaydugad/Desktop/JPPY2218/SOURCE CODE/Intrusion Detection System/intrusion.pkl','rb'))
@app.route('/')
...
def preview():
    if request.method == 'POST':
        ...
        # Read the file as DataFrame (assuming it's CSV)
        df = pd.read_csv(dataset, encoding='unicode_escape')
